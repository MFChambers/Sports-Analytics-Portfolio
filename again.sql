...
INSERT INTO Players (Name, Position, TeamID)
VALUES 
('Player Name', 'Position', TeamID);
INSERT INTO Games (Date, Opponent, Location, TeamScore, OpponentScore, Outcome)
VALUES 
('2024-12-01', 'New York Liberty', 'Home', 85, 80, 'Win');
INSERT INTO PlayerStats (PlayerID, GameID, GP, GS, MIN, PTS, OffReb, DR, REB, AST, STL, BLK, Turnovers, PF, AST_TO)
VALUES 
(1, 1, 40, 40, 35.4, 20.2, 0.4, 5.3, 5.7, 8.4, 1.3, 0.7, 5.6, 2.8, 1.5);
INSERT INTO ShootingStats (PlayerID, GameID, FGM, FGA, FGPercent, TPM, TPA, TPPercent, FTM, FTA, FTPercent, TPM2, TPA2, TPPercent2, SC_EFF, SH_EFF)
VALUES 
(1, 1, 6.1, 14.5, 41.7, 3.1, 8.9, 34.4, 4.1, 4.5, 90.6, 3.0, 5.6, 53.3, 1.326, 0.52);
